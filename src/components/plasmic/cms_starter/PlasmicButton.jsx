...
import sty from "./PlasmicButton.module.css"; // plasmic-import: j8KNj6LByxjj/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: qNMcfYi0wDlL/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 1Dirh_I4ZZRa/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cybrH)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__km2Qt)}
                role={"img"}
              />
            ),
